  ...
  return (
    <section className="sm:h-[calc(100vh-68px)] flex flex-col md:flex-row items-center justify-between px-6 md:px-20 py-16 bg-gradient-to-r from-blue-700 to-blue-500 text-white">
      <div className="md:w-1/2 text-center md:text-left">
        ...
        <p className="pt-4 text-lg text-blue-100 md:max-w-lg md:text-start text-center">
        ...
        <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 gap-6 text-blue-100">
          <div className="flex flex-col items-center md:items-start gap-2 hover:scale-105 transition">
      ...
      <div className="md:w-1/2 flex justify-center pt-10 md:pt-0">
        <img
          ...
          className="sm:h-[380px] sm:w-[580px] rounded-2xl shadow-2xl w-full hover:scale-105 transition duration-300"
        />
      </div>
    </section>
  );
